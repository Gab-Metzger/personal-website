	...
	<body class="loading">
		<div id="wrapper">
			...
			<div id="main">
				...
				<!-- Header -->
					<header id="header">
						<h1>Gabriel METZGER</h1>
						<p>Web & Mobile developer &nbsp;&bull;&nbsp; Freelance</p>
						<nav>
							<ul>
								<li><a href="https://twitter.com/Gab_Metzger" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
				...
				<!-- Footer -->
					<footer id="footer">
						<span class="copyright">&copy; Gabriel METZGER. Design: <a href="http://html5up.net">HTML5 UP</a>.</span>
					</footer>
